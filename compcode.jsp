...
{{"compcode"}, {"nelem","1"},{"musthave","0"},{"group","0"},{"gminmax","1.1"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}},
{{"mturkcode"},{"choices","rat1"},{"stem","Finally, in order to receive your mTurk credit please generate your own five-digit numeric code that you also enter on the Mechanical Turk page. Please try to generate a code that is unique to you  (Do NOT use 12345 for example). Once you have entered your code in the box below and on mTurk press the 'Next' button twice to complete the study."}},
};
...
// #BDEDFF light blue
 ...
 // var minselect = js_minselect[curitem];
  ...
  var curdisplay='<table width="80%" align=center><tr><td><font color="#AAAAAA"><b>Completion Code'+'</b></font>'+'<br /> <span  class=med>'+js_prefix[curitem]+'</span><br/><span class=big style="background-color: #FFFFCC;">'+js_stem[curitem]+'</span><br/><br/></td></tr></table> <table width="80%" align=center cellpadding="1">';
  ...
  if (curitem==0) {
    ...
    curdisplay+='<input type=text style="font-size:14; font-weight: bold;" length=12 maxlength=5 id="text2" name="text2" onkeypress="keyCode=(event.which)?event.which:event.keyCode;return (keyCode != 13); " onkeydown="keyCode=(event.which)?event.which:event.keyCode;return (keyCode != 13); "> <br/><br/>';

    

    curdisplay+='<button type="button" id="thisbut" style="font-size:14; font-weight: bold; width: 100px; background-color:#EEEEEE" onmouseup=\'changestate(0,"text2",3,"thisbut")\'>Next</button></td></tr>';
