...
{
{{"eval1"},{"nelem","5"},{"musthave","0"},{"group","0"},{"gminmax","5.5"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}}, 
{{"relation1"},{"choices","rat1"},{"stem","In the scenario you just read and were asked to imagine, who was Bob?"}},
{{"action1"},{"choices","rat2"},{"stem","In the end, what did Bob decide to do? What action did he take?"}},
{{"moral1"},{"choices","rat3"},{"stem","In your opinion, how morally right or wrong were Bob’s actions?"}},
{{"loyal1"},{"choices","rat4"},{"stem","In your opinion, how loyal or disloyal were Bob’s actions? "}},
{{"liking1"},{"choices","rat5"},{"stem","How do you feel about Bob?"}}
};
