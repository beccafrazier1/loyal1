...
String[][][] ratings =
	{
	{{"ratings"},{"ncols","1"},{"direction","left"},{"flow","horizontal"}},	
	{{"rat13"},{"options","I am strongly liberal on social issues","I am moderately liberal  on social issues","I am slightly liberal on social issues","I am in the middle on social issues","I am slightly conservative on social issues","I am moderately conservative on social issues","I am strongly conservative on social issues"}},
 {{"rat14"},{"options","I am strongly liberal on economic issues","I am moderately liberal  on economic issues","I am slightly liberal on economic issues","I am in the middle on economic issues","I am slightly conservative on economic issues","I am moderately conservative on economic issues","I am strongly conservative on economic issues"}},
{{"rat15"},{"options","Democrat","Republican","Independent-- I don't identify with a Party","Libertarian", "Green", "Other", "Don't Know"}},
{{"rat16"},{"options","I am strongly liberal","I am moderately liberal","I am slightly liberal","I am in the middle","I am slightly conservative","I am moderately conservative","I am strongly conservative"}},
{{"rat17"},{"ncols","6"},{"flow","vertical"},{"options","0%","5%","10%","15%","20%","25%","30%",
...
{
{{"dem"},{"nelem","5"},{"musthave","0"},{"group","0"},{"gminmax","5.5"},{"gplace","0"},{"gorder","0"},{"gsequence","random"}}, 
{{"socialpoliticalid"},{"choices","rat13"},{"stem","Please indicate your political identity on <u>social issues</u>  (e.g.,  abortion, gun control, gay rights)."}},
{{"econpoliticalid"},{"choices","rat14"},{"stem","Please indicate your political identity on <u>economic issues</u>  (e.g., taxation, government spending)."}},
{{"politicalid"},{"choices","rat16"},{"stem","Please indicate your overall political identity..."}},
{{"partyid"},{"choices","rat15"},{"stem","What is your political identification?"}},
{{"moralfit"},{"choices","rat17"},{"stem","What percent of people in your community do you believe share your political beliefs?"}}
};
...
// #BDEDFF light blue
 ...
 // var minselect = js_minselect[curitem];
  ...
  var curdisplay='<table width="70%" align=center><tr><td><font color="#AAAAAA"><span  class=small><b>Section 1: '+(curitem+1)+'/'+js_nitem+' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </b></span></font><br /><span  class='+preclass+'>'+js_prefix[curitem]+'</span><br/><span class=big style="background-color: #FFFFCC">'+js_stem[curitem]+'</span><br/><br/></td></tr></table> <table width="70%" align=center cellpadding="2">';
