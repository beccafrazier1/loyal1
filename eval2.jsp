...
String[][][] ratings =
	...
	{{"rat1"},{"options","Your brother","Your coworker who worked with you at the start up company Galaxy","Your coworker at the Pharmaceutical company Flaxo","Your teammate on your soccer team the Eagles"}},
 {{"rat2"},{"options","Hired his brother over the other candidate","Hired the more qualified candidate instead of his brother","Stayed with your company Galaxy","Switched to the competing company Helio","Kept quiet about the preliminary results","Released the preliminary results to the press","Stayed on your team, the Eagles","Switched to the opposing team, the Strikers"}},
{{"rat3"},{"options","Not at all Immoral", "Very Slightly Immoral", "Slightly Immoral", "Somewhat Immoral", "Moderately Immoral", "Very Immoral", "Extremely Immoral", "One of the most immoral things that could be done"}},
{{"rat4"},{"options","Not at all Disloyal", "Very Slightly Disloyal", "Slightly Disloyal", "Somewhat Disloyal", "Moderately Disloyal", "Very Disloyal", "Extremely Disloyal", "One of the most disloyal things that could be done"}},
{{"rat5"},{"options","Extremely Positive","Very Positive","Moderately Positive","Slightly Positive","Slightly Negative","Moderately Negative","Very Negative","Extremely Negative"}}
		};
...
{
{{"eval2"},{"nelem","5"},{"musthave","0"},{"group","0"},{"gminmax","5.5"},{"gplace","0"},{"gorder","0"},{"gsequence","fixed"}}, 
{{"relation2"},{"choices","rat1"},{"stem","In the scenario you just read and were asked to imagine, who was John?"}},
{{"action2"},{"choices","rat2"},{"stem","In the end, what did John decide to do? What action did he take?"}},
{{"moral2"},{"choices","rat3"},{"stem","In your opinion, how morally right or wrong were John’s actions?"}},
{{"loyal2"},{"choices","rat4"},{"stem","In your opinion, how loyal or disloyal were John’s actions? "}},
{{"liking2"},{"choices","rat5"},{"stem","How do you feel about John?"}}
};
